...
NGame = {
	...
	GAME_SPEED_SECONDS = { 100.0, 0.25, 0.1, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	TRUCE_PERIOD_AFTER_KICKING_FROM_FACTION = 90,				-- Truce period after kicking someone from faction in days.
	NUM_DAYS_TO_ENABLE_KICKING_NEW_MEMBERS_OF_FACTION = 0,			-- Number of days before being able to kick a new member of faction
	NUM_DAYS_TO_ENABLE_REINVITE_KICKED_NATIONS = 0,			-- Number of days before being able to re invite a kicked nation to your faction
	BASE_NEGATIVE_OPINION_AFTER_BEING_KICKED = 0,				-- Negative opinion that will be received after kicking a nation
...
NMilitary = {
	...
	USE_MULTIPLICATIVE_ORG_LOSS_WHEN_MOVING = false, -- whether to apply org_loss_when_moving modifiers additively or multiplicatively (hardcoded multiplicative pre-2021)
	...
	NEW_COMMANDER_RANDOM_PERSONALITY_TRAIT_CHANCES = {  -- chances to gain a personality trait for new generals
		1.0, -- 100% chance for 1st trait 
		0.4,  -- 40% chance for 2nd trait 
		0.05, -- 5% chance for 3rd trait 
		0.01, -- 1% chance for 4th trait 
	},
...
NNavy = {
	...
	PRIDE_OF_THE_FLEET_LOST_TEMP_MODIFIER_DURATION = 180,			-- duration for temp modifiers that you get when you lose your pride of the fleet
	...
	TRAINING_ACCIDENT_CRITICAL_HIT_CHANCES = 0.01,					-- If an accident happens, how likely it is to be a critical hit
	TRAINING_ACCIDENT_CRITICAL_HIT_DAMAGE_SCALE = 0.01,				-- Scale the value below in case of critical hit
	...
	TRAINING_ACCIDENT_ORG_LOSS_FACTOR = 0.01,						-- Amount of current organization the ship lose
